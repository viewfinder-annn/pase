...
model = WavLM_feat()
ckpt_finetuned = "/work/user_data/xiaobin/Experiments/exp_StuPASE/exp_DeWavLM-R_2026-06-08-08h54m/checkpoints/best_model_096.tar"
...
save_path = "/work/user_data/xiaobin/Pre-trained/StuPASE_new"
os.makedirs(save_path, exist_ok=True)
wavlm_ckpt_path_new = f"{save_path}/DeWavLM-R.pt"
