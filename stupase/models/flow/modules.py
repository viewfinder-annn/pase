...
# MIT license.
# Source: https://github.com/ASLP-lab/SenSE/blob/main/src/sense/model/modules.py
...
class MelSpec(nn.Module):
    def __init__(
        ...
        super().__init__()
        assert mel_spec_type in ["vocos"], print("We only support four extract mel backend: vocos")
